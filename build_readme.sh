...
cat >> README.md <<- END
# Getting Started
Click this button [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/git/`git config --get remote.origin.url | urlencode`/HEAD) to run this project!
